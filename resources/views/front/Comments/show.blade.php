        ...
        <body>
            ...
            <ol class="border-l md:border-l-0 md:border-t border-gray-300 md:flex md:justify-center md:gap-6">
                <li>
                    ...
                    <p class="text-gray-500 text-sm mt-2">{{$Comments[0]->create_at}}</p>
                    </div>
                    <div class="mt-0.5 ml-4 md:ml-0 pb-5">
                    <h4 class="text-gray-800 font-semibold text-xl mb-1.5">{{$Comment[0]->user_id}}</h4>
                    <p class="text-gray-500 mb-3">{{$Comment[0]->comment}}</p>
                    </div>
                </li>
            </ol>
        </body>
